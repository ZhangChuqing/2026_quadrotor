...
// 拨弹轮 
#define RAMMER_OUTER_KP         1.0f    
#define RAMMER_OUTER_KI         0.0f
#define RAMMER_OUTER_KD         0.05f   
#define RAMMER_OUTER_OUT_LIMIT  0.1f  
#define RAMMER_OUTER_IOUT_LIMIT 0.0f
#define RAMMER_INNER_KP         5.0f   
#define RAMMER_INNER_KI         0.5f    
#define RAMMER_INNER_KD         0.0f
#define RAMMER_INNER_OUT_LIMIT  1000.0f 
 ...
 *                            云台角度限制
 ******************************************************************************/
#define PITCH_UPPER_LIMIT 0.26f
